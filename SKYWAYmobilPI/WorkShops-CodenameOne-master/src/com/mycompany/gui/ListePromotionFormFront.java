 ...
 * @author Lenovo
 */
public class ListePromotionFormFront extends BaseForm{
    Form current;
    public ListePromotionFormFront(Resources res)
    {
      ...
      setTitle ("AJouter Promotion");
        ...
        RadioButton partage = RadioButton.createToggle("Promotions", barGroup);
        ...
        new ListePromotionFormFront(res).show();
...
//   private void addButton(Image img ,String codeP, int reduction,String dated,String datef,Promotion promo,Resources res)
  ...
  /*   TextArea ta = new TextArea (codeP);
   ...
   Label idPromo = new Label ("idP: "+promo.getCodeP(),"NewsTopLine2");
  Label codeText = new Label ("Code promo: "+promo.getCodeP(),"NewsTopLine2");
  Label reductionText = new Label (""+promo.getReduction()+"%","NewsTopLine2");
  ...
  // Label idP = new Label ("Partenaire"+promo.getIdP(),"NewsTopLine2");
    Label idP = new Label ("Chez "+promo.getNom(),"NewsTopLine2");
  createLineSeparator();
...
{ 
 ...
 lqr.setUIID ("NewsTopLine");
 Style qrStyle = new Style (lqr.getUnselectedStyle());
 qrStyle.setFgColor(0x006600);
 
 
 FontImage qrImage = FontImage.createMaterial(FontImage.MATERIAL_ADD_A_PHOTO, qrStyle);
 lqr.setIcon(qrImage);
 lqr.setTextPosition(RIGHT);
 
 //clixk delete btn
 lqr.addPointerPressedListener(e -> Display.getInstance().execute("https://chart.googleapis.com/chart?cht=qr&chl="+promo.getCodeP()+"&choe=UTF-8&chs=500x500"));
  //.getToolbar().addCommandToRightBar("Get Key", null, e -> Display.getInstance().execute("https://chart.googleapis.com/chart?cht=qr&chl="+promo.getCodeP()+"&choe=UTF-8&chs=500x500"));
...
new ModifierPromotionForm(res,promo).show();
 ...
 cnt.add(BorderLayout.CENTER, BoxLayout.encloseY(
         ...
         BoxLayout.encloseX(reductionText,lmodifier,lsupprimer),
         // BoxLayout.encloseX(datedText),
          // BoxLayout.encloseX(datefText),
           BoxLayout.encloseX(datedText,datefText) ,
         BoxLayout.encloseX(idP,lqr)) );
